const { matchService } = require('../src/calendar/tidy')

const testCases = [
    {
        calendarData: {
            summary: 'SMS for Zoho Standup',
            calendarName: 'Calendar',
            startDate: '2023-01-13T05:30:00.000Z',
            endDate: '2023-01-13T05:45:00.000Z',
            location: null,
            description:
            ...
            url: 'https://teams.microsoft.com/l/meetup-join/19%3ameeting_ZmYwYTY4YjctMzMxMi00MmU5LWFjYTAtNjMwMzE5NzM4Y2Fl%40thread.v2/0?context=%7b%22Tid%22%3a%223b518aae-8921-4a7b-8497-619d756ce20e%22%2c%22Oid%22%3a%22b97e1b4b-edb5-48eb-a783-b64a66a55333%22%7d>',
            id: 'BD834825-C84B-48EB-9B3E-5B531ED15F6D',
        },
        expectedUrl:
            'https://teams.microsoft.com/l/meetup-join/19%3ameeting_ZmYwYTY4YjctMzMxMi00MmU5LWFjYTAtNjMwMzE5NzM4Y2Fl%40thread.v2/0?context=%7b%22Tid%22%3a%223b518aae-8921-4a7b-8497-619d756ce20e%22%2c%22Oid%22%3a%22b97e1b4b-edb5-48eb-a783-b64a66a55333%22%7d',
    },
]
...
testCases.forEach((testCase) => {
    ...
    if (actualResult.url !== testCase.expectedUrl) {
        throw new Error(
            `Expected ${testCase.expectedUrl} - actual ${actualResult.url}`
        )
    }
})
